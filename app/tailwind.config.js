    ...
    extend: {
      colors: {
        ...
        app: {
          ...
          "ink-dim": "rgb(var(--app-ink-dim) / <alpha-value>)",
          "ink-mute": "rgb(var(--app-ink-mute) / <alpha-value>)",
          border: ({ opacityValue }) =>
            opacityValue === undefined
              ? "rgb(var(--app-border-rgb) / var(--app-border-alpha))"
              : `rgb(var(--app-border-rgb) / ${opacityValue})`,
          lavender: "rgb(var(--app-lavender) / <alpha-value>)",
          peach: "rgb(var(--app-peach) / <alpha-value>)",
          mint: "rgb(var(--app-mint) / <alpha-value>)",
          butter: "rgb(var(--app-butter) / <alpha-value>)",
          accent: "rgb(var(--app-accent) / <alpha-value>)",
          charcoal: "rgb(var(--app-charcoal) / <alpha-value>)",
        },
      },
      fontFamily: {
        sans: [
